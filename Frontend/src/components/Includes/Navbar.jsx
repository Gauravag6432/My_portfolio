...
import { Menu, X, Code, Briefcase, BriefcaseBusiness, User, Home, Send, Activity} from 'lucide-react';
...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: 'Experience', href: '#experience', icon: <BriefcaseBusiness size={18} /> },
  ...
  return (
    <nav 
      className={`fixed w-full z-50 transition-all duration-300 bg-gray-50 dark:bg-gray-900`}
    >
